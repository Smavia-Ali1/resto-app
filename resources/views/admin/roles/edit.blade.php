            ...
            <div class="p-2 mt-6">
                ...
                <div class="flex space-x-2 mt-4 p-2">
                    @if($role->permissions)
                        ...
                        <form action="{{ route('admin.roles.permissions.revoke', [$role->id, $role_permission] ) }}" class="text-white bg-red-600 hover:bg-red-700 rounded-lg text-sm px-2 py-2"
                            method="POST"
